...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _init: function (options, refreshMode) {
            ...
            self.$captionIcon = self.$captionContainer.find('.d');
        ...
        _initTemplateDefaults: function () {
            ...
            tCaption = '<div class="file-caption form-control {class}" tabindex="500">\n' +
                '  <input class="file-caption-name" name="image" onkeydown="return false;" onpaste="return false;">\n' +
                '</div>';
            //noinspection HtmlUnknownAttribute
